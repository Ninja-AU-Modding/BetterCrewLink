...
public static class ColliderMaps
{
    [SuppressMessage("Design", "S2386", Justification = "Static collider data, intentionally public")]
    [SuppressMessage("Design", "S3887", Justification = "Static collider data, intentionally public")]
    public static readonly Dictionary<MapType, string[]?> Colliders = new()
    {
        [MapType.TheSkeld] =
        [
        ...
        [MapType.TheSkeldApril] = null,
        [MapType.Unknown] = null,
    };

    [SuppressMessage("Design", "S2386", Justification = "Static door data, intentionally public")]
    [SuppressMessage("Design", "S3887", Justification = "Static map data, intentionally public")]
    public static readonly Dictionary<MapType, Dictionary<int, string>?> Doors = new()
    {
        [MapType.MiraHQ] = new()
        {
        ...
        [MapType.Submerged] = null,
        [MapType.TheSkeldApril] = null,
        [MapType.Unknown] = null,
    };
    public static bool PoseCollide(Vector2 p1, Vector2 p2)
    {
        return Physics2D.Linecast(p1, p2, LayerMask.GetMask("Ship"));
    }
}